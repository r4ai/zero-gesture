...
const MANIFESTS = [
  ...
  },
  {
    ...
    idPattern:
      /^P04B3A-(?:PERMISSION|ISOLATION|REQUEST|FAILURE|STRING|IDENTITY|CACHE|MATCH|LIFECYCLE)-\d{3}$/,
    idDescription:
      "P04B3A-PERMISSION-NNN, P04B3A-ISOLATION-NNN, P04B3A-REQUEST-NNN, P04B3A-FAILURE-NNN, P04B3A-STRING-NNN, P04B3A-IDENTITY-NNN, P04B3A-CACHE-NNN, P04B3A-MATCH-NNN, or P04B3A-LIFECYCLE-NNN",
  },
]
