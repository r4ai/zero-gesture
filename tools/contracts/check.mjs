...
const MANIFESTS = [
  ...
  {
    label: "P04b3c-a",
    path: "contracts/p04b3c-a-macos-active-input.json",
    idPattern:
      /^P04B3CA-(?:ACTIVE|HOT|OVERLOAD|CALLBACK|REVALIDATE|REPLAY|FAILURE|LIFECYCLE)-\d{3}$/,
    idDescription:
      "P04B3CA-ACTIVE-NNN, P04B3CA-HOT-NNN, P04B3CA-OVERLOAD-NNN, P04B3CA-CALLBACK-NNN, P04B3CA-REVALIDATE-NNN, P04B3CA-REPLAY-NNN, P04B3CA-FAILURE-NNN, or P04B3CA-LIFECYCLE-NNN",
  },
  {
    label: "P04b3c-b",
    path: "contracts/p04b3c-b-macos-native-overlay.json",
    idPattern:
      /^P04B3CB-(?:QUEUE|SCHEDULE|OWNERSHIP|WINDOW|TRAIL|LABEL|DISPLAY|LIFECYCLE|FAILURE|SHUTDOWN)-\d{3}$/,
    idDescription:
      "P04B3CB-QUEUE-NNN, P04B3CB-SCHEDULE-NNN, P04B3CB-OWNERSHIP-NNN, P04B3CB-WINDOW-NNN, P04B3CB-TRAIL-NNN, P04B3CB-LABEL-NNN, P04B3CB-DISPLAY-NNN, P04B3CB-LIFECYCLE-NNN, P04B3CB-FAILURE-NNN, or P04B3CB-SHUTDOWN-NNN",
  },
  {
    label: "P05a",
